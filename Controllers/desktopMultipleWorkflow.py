        ...
        for loop in range(number_of_plays):
            for index, obj in enumerate(data):
                ...
                if action == "pressed_key" or action == "released_key":
                    ...
                    if(action=="pressed_key" and key=="r"):
                        manualList.append(["","","","",""])
                        for locale in localegroup:
                            print("Insert Time...")
                            getLangCode = verifyIMEpresent(locale)
    ...
    ## Korean Test Cases        
        ...
        try:
                ...
                try :
                    ...
                    print(e.__doc__)
                    print (e)
                newsendonereportMail(productPath,notificationMail,localegroup,fileName,IMEChange,TypingChars,appCrashed,name_of_recording)
